...
func (r *Binding) AsDaggerCli() *DaggerCli { // dagger-cli (../../../../toolchains/cli-dev/main.go:70:6)
...
type DaggerCli struct { // dagger-cli (../../../../toolchains/cli-dev/main.go:70:6)
...
type DaggerCliBinaryOpts struct {
	Platform Platform // dagger-cli (../../../../toolchains/cli-dev/main.go:80:2)
}

// Build the dagger CLI binary for a single platform
func (r *DaggerCli) Binary(opts ...DaggerCliBinaryOpts) *File { // dagger-cli (../../../../toolchains/cli-dev/main.go:78:1)
...
type DaggerCliDevBinariesOpts struct {
	Platform Platform // dagger-cli (../../../../toolchains/cli-dev/main.go:114:2)
}

// Build dev CLI binaries
// TODO: remove this
func (r *DaggerCli) DevBinaries(opts ...DaggerCliDevBinariesOpts) *Directory { // dagger-cli (../../../../toolchains/cli-dev/main.go:112:1)
...
type DaggerCliReferenceOpts struct {
	Frontmatter string // dagger-cli (../../../../toolchains/cli-dev/main.go:92:2)
	//
	// Include experimental commands
	//
	IncludeExperimental bool // dagger-cli (../../../../toolchains/cli-dev/main.go:95:2)
}

// Generate a markdown CLI reference doc
func (r *DaggerCli) Reference(opts ...DaggerCliReferenceOpts) *File { // dagger-cli (../../../../toolchains/cli-dev/main.go:90:1)
...
func (r *DaggerCli) Tag(ctx context.Context) (string, error) { // dagger-cli (../../../../toolchains/cli-dev/main.go:72:2)
	if r.tag != nil {
		return *r.tag, nil
	}
...
func (r *DaggerCli) Version(ctx context.Context) (string, error) { // dagger-cli (../../../../toolchains/cli-dev/main.go:71:2)
	if r.version != nil {
...
func (r *Env) WithDaggerCliInput(name string, value *DaggerCli, description string) *Env { // dagger-cli (../../../../toolchains/cli-dev/main.go:70:6)
...
func (r *Env) WithDaggerCliOutput(name string, description string) *Env { // dagger-cli (../../../../toolchains/cli-dev/main.go:70:6)
