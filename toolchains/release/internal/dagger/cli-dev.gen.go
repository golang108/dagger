...
type CliDevDevBinariesOpts struct {
	Platform Platform // cli-dev (../../../../toolchains/cli-dev/main.go:118:2)
}

// Build dev CLI binaries
// TODO: remove this
func (r *CliDev) DevBinaries(opts ...CliDevDevBinariesOpts) *Directory { // cli-dev (../../../../toolchains/cli-dev/main.go:116:1)
...
type CliDevReferenceOpts struct {
	Frontmatter string // cli-dev (../../../../toolchains/cli-dev/main.go:96:2)
	//
	// Include experimental commands
	//
	IncludeExperimental bool // cli-dev (../../../../toolchains/cli-dev/main.go:99:2)
}

// Generate a markdown CLI reference doc
func (r *CliDev) Reference(opts ...CliDevReferenceOpts) *File { // cli-dev (../../../../toolchains/cli-dev/main.go:94:1)
