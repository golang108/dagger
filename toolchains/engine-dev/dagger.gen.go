				...
				dag.TypeDef().WithObject("EngineDev", dagger.TypeDefWithObjectOpts{SourceMap: dag.SourceMap("main.go", 62, 6)}).
					...
					WithConstructor(
						dag.Function("New",
							...
							WithArg("source", dag.TypeDef().WithObject("Directory").WithOptional(true), dagger.FunctionWithArgOpts{SourceMap: dag.SourceMap("main.go", 45, 2), DefaultPath: "/", Ignore: []string{"*", "!.git", "!dagger.json", "!**/dagger.json", "!dagger.toml", "!**/dagger.toml", "!**/go.*", "!**/*.dang", "!core", "!engine", "!util", "!network", "!dagql", "!analytics", "!auth", "!cmd", "!internal", "!sdk", "sdk/**/examples", "!cmd", "!modules", "!toolchains", "!.changes"}}).
