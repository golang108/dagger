...
func (r *Binding) AsGo() *Go { // go (../../../../toolchains/go/main.go:183:6)
...
func (r *Env) WithGoInput(name string, value *Go, description string) *Env { // go (../../../../toolchains/go/main.go:183:6)
...
func (r *Env) WithGoOutput(name string, description string) *Env { // go (../../../../toolchains/go/main.go:183:6)
...
// A Go project
type Go struct { // go (../../../../toolchains/go/main.go:183:6)
...
func (r *Go) Base() *Container { // go (../../../../toolchains/go/main.go:197:2)
...
type GoBinaryOpts struct {
	...
	//
	NoSymbols bool // go (../../../../toolchains/go/main.go:371:2)
	//
	// Disable DWARF generation
	//
	NoDwarf bool // go (../../../../toolchains/go/main.go:374:2)
	//
	// Target build platform
	//
	Platform Platform // go (../../../../toolchains/go/main.go:377:2)
}

// Build a single main package, and return the compiled binary
func (r *Go) Binary(pkg string, opts ...GoBinaryOpts) *File { // go (../../../../toolchains/go/main.go:365:1)
...
type GoBuildOpts struct {
	...
	//
	// Default: ["./..."]
	Pkgs []string // go (../../../../toolchains/go/main.go:313:2)
	//
	// Disable symbol table
	//
	NoSymbols bool // go (../../../../toolchains/go/main.go:316:2)
	//
	// Disable DWARF generation
	//
	NoDwarf bool // go (../../../../toolchains/go/main.go:319:2)
	//
	// Target build platform
	//
	Platform Platform // go (../../../../toolchains/go/main.go:322:2)
	//
	// Output directory
	//
	//
	// Default: "./bin/"
	Output string // go (../../../../toolchains/go/main.go:326:2)
}

// Build the given main packages, and return the build directory
func (r *Go) Build(opts ...GoBuildOpts) *Directory { // go (../../../../toolchains/go/main.go:308:1)
...
// Go build cache
func (r *Go) BuildCache() *CacheVolume { // go (../../../../toolchains/go/main.go:194:2)
...
// Enable CGO
func (r *Go) Cgo(ctx context.Context) (bool, error) { // go (../../../../toolchains/go/main.go:209:2)
	if r.cgo != nil {
		return *r.cgo, nil
	}
...
type GoCheckTidyOpts struct {
	Include []string // go (../../../../toolchains/go/main.go:700:2)

	Exclude []string // go (../../../../toolchains/go/main.go:701:2)
}

// Check if 'go mod tidy' is up-to-date
func (r *Go) CheckTidy(ctx context.Context, opts ...GoCheckTidyOpts) error { // go (../../../../toolchains/go/main.go:698:1)
	if r.checkTidy != nil {
		return nil
	}
...
func (r *Go) Download() *Go { // go (../../../../toolchains/go/main.go:232:1)
...
type GoEnvOpts struct {
	Platform Platform // go (../../../../toolchains/go/main.go:253:2)
}
...
func (r *Go) Env(opts ...GoEnvOpts) *Container { // go (../../../../toolchains/go/main.go:251:1)
...
func (r *Go) Exclude(ctx context.Context) ([]string, error) { // go (../../../../toolchains/go/main.go:219:2)
...
func (r *Go) Experiment(ctx context.Context) ([]string, error) { // go (../../../../toolchains/go/main.go:215:2)
...
func (r *Go) GenerateDaggerRuntime(start string) *Go { // go (../../../../toolchains/go/main.go:623:1)
...
func (r *Go) GenerateDaggerRuntimes() *Changeset { // go (../../../../toolchains/go/main.go:586:1)
...
func (r *Go) Include(ctx context.Context) ([]string, error) { // go (../../../../toolchains/go/main.go:217:2)
...
func (r *Go) Ldflags(ctx context.Context) ([]string, error) { // go (../../../../toolchains/go/main.go:200:2)
...
func (r *Go) Limit(ctx context.Context) (int, error) { // go (../../../../toolchains/go/main.go:222:2)
	if r.limit != nil {
		return *r.limit, nil
	}
...
type GoLintOpts struct {
	Include []string // go (../../../../toolchains/go/main.go:770:2)

	Exclude []string // go (../../../../toolchains/go/main.go:771:2)
}

// Lint the project
func (r *Go) Lint(ctx context.Context, opts ...GoLintOpts) error { // go (../../../../toolchains/go/main.go:768:1)
	if r.lint != nil {
		return nil
	}
...
func (r *Go) LintModule(ctx context.Context, module string) error { // go (../../../../toolchains/go/main.go:796:1)
	if r.lintModule != nil {
		return nil
	}
...
type GoListPackagesOpts struct {
	...
	//
	// Default: ["./..."]
	Pkgs []string // go (../../../../toolchains/go/main.go:461:2)
	//
	// Only list main packages
	//
	OnlyMain bool // go (../../../../toolchains/go/main.go:464:2)
}

// List packages matching the specified criteria
func (r *Go) ListPackages(ctx context.Context, opts ...GoListPackagesOpts) ([]string, error) { // go (../../../../toolchains/go/main.go:456:1)
...
// Go module cache
func (r *Go) ModuleCache() *CacheVolume { // go (../../../../toolchains/go/main.go:191:2)
...
type GoModulesOpts struct {
	Include []string // go (../../../../toolchains/go/main.go:536:2)

	Exclude []string // go (../../../../toolchains/go/main.go:537:2)
}

// Scan the source for go modules, and return their paths
func (r *Go) Modules(ctx context.Context, opts ...GoModulesOpts) ([]string, error) { // go (../../../../toolchains/go/main.go:534:1)
...
func (r *Go) Race(ctx context.Context) (bool, error) { // go (../../../../toolchains/go/main.go:212:2)
	if r.race != nil {
		return *r.race, nil
	}
...
func (r *Go) Source() *Directory { // go (../../../../toolchains/go/main.go:188:2)
...
func (r *Go) Tags(ctx context.Context) ([]string, error) { // go (../../../../toolchains/go/main.go:203:2)
...
type GoTestOpts struct {
	...
	//
	Run string // go (../../../../toolchains/go/main.go:407:2)
	//
	// Skip these tests
	//
	Skip string // go (../../../../toolchains/go/main.go:410:2)
	//
	// Abort test run on first failure
	//
	Failfast bool // go (../../../../toolchains/go/main.go:413:2)
	//
	// How many tests to run in parallel - defaults to the number of CPUs
	//
	Parallel int // go (../../../../toolchains/go/main.go:417:2)
	//
	// How long before timing out the test run
	//
	//
	// Default: "30m"
	Timeout string // go (../../../../toolchains/go/main.go:421:2)

	// Default: 1
	Count int // go (../../../../toolchains/go/main.go:424:2)
	//
	// Which packages to test
	//
	//
	// Default: ["./..."]
	Pkgs []string // go (../../../../toolchains/go/main.go:428:2)
}

// Run tests for the given packages
func (r *Go) Test(ctx context.Context, opts ...GoTestOpts) error { // go (../../../../toolchains/go/main.go:403:1)
	if r.test != nil {
		return nil
	}
...
type GoTestsOpts struct {
	...
	//
	// Default: ["./..."]
	Pkgs []string // go (../../../../toolchains/go/main.go:298:2)
}

// List tests
func (r *Go) Tests(ctx context.Context, opts ...GoTestsOpts) (string, error) { // go (../../../../toolchains/go/main.go:293:1)
	if r.tests != nil {
		return *r.tests, nil
	}
...
type GoTidyOpts struct {
	Include []string // go (../../../../toolchains/go/main.go:559:2)

	Exclude []string // go (../../../../toolchains/go/main.go:560:2)
}

func (r *Go) Tidy(opts ...GoTidyOpts) *Changeset { // go (../../../../toolchains/go/main.go:557:1)
...
func (r *Go) TidyModule(module string) *Changeset { // go (../../../../toolchains/go/main.go:546:1)
...
func (r *Go) Values(ctx context.Context) ([]string, error) { // go (../../../../toolchains/go/main.go:206:2)
...
// Go version
func (r *Go) Version(ctx context.Context) (string, error) { // go (../../../../toolchains/go/main.go:185:2)
	if r.version != nil {
...
type GoOpts struct {
	...
	// Project source directory
	//
	Source *Directory // go (../../../../toolchains/go/main.go:30:2)
	//
	// Go version
	//
	//
	// Default: "1.26"
	Version string // go (../../../../toolchains/go/main.go:34:2)
	//
	// Use a custom module cache
	//
	ModuleCache *CacheVolume // go (../../../../toolchains/go/main.go:37:2)
	//
	// Use a custom build cache
	//
	BuildCache *CacheVolume // go (../../../../toolchains/go/main.go:41:2)
	//
	// Use a custom base container.
	// The container must have Go installed.
	//
	Base *Container // go (../../../../toolchains/go/main.go:46:2)
	//
	// Pass arguments to 'go build -ldflags'
	//
	Ldflags []string // go (../../../../toolchains/go/main.go:50:2)
	//
	// Pass arguments to 'go build -tags'
	//
	Tags []string // go (../../../../toolchains/go/main.go:54:2)
	//
	// Add string value definition of the form importpath.name=value
	// Example: "github.com/my/module.Foo=bar"
	//
	Values []string // go (../../../../toolchains/go/main.go:59:2)
	//
	// Enable CGO
	//
	Cgo bool // go (../../../../toolchains/go/main.go:63:2)
	//
	// Enable race detector. Implies cgo=true
	//
	Race bool // go (../../../../toolchains/go/main.go:67:2)
	//
	// Enable go experiments https://pkg.go.dev/internal/goexperiment
	//
	Experiment []string // go (../../../../toolchains/go/main.go:71:2)
	//
	// extra system packages to include in the default base image; only
	// valid if 'base' arg is nil
	//
	ExtraPackages []string // go (../../../../toolchains/go/main.go:76:2)
	//
	// max number of parallel jobs to run for tidy/check tidy/lint/runtime generation
	//
	//
	// Default: 10
	Limit int // go (../../../../toolchains/go/main.go:80:2)
	//
	...
	//
	Repo *GitRepository // go (../../../../toolchains/go/main.go:94:2)
}

// A Go project
func (r *Query) Go(opts ...GoOpts) *Go { // go (../../../../toolchains/go/main.go:25:1)
	q := r.query.Select("go")
	for i := len(opts) - 1; i >= 0; i-- {
